...
if (isset($_POST['btnUpdate'])) {
    ...
    if ($updateResult) {
        echo "<script>alert('Profile updated successfully'); window.location='profile.php?id=$uId';</script>";
    } else {
...
<form action="profileEdit.php?id=<?php echo $userid ?>" method="POST" enctype="multipart/form-data">

    <input type="text" name="txtUserId" value="<?php echo $userid?>">
